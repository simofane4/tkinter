...
class App:
    def __init__(self, top):
        ...
        self.lbl1 = Label(self.top, text="Management Spare Parts", font=("times new roman", 20, "bold")).place(x=300,
                                                                                                               y=65)
        self.lbl2 = Label(self.top, text=localtime, bg="#091833", font=("times new roman", 20, "bold")).place(x=300, y=95).clock()                                                                                                  y=85)
