...
#label4 = tk.Label(app, text="Email_Client  :", bg="#6A6A6A", font=("Arial Greek", 9, "bold"), fg="black").place(x=12, y=359)
#txt_lb4 = tk.Entry(app, font=("Arial Greek", 12, "bold")).place(x=100, y=362, width=130, height=18)

#label5 = tk.Label(app, text="Télé_client    :", bg="#6A6A6A", font=("Arial Greek", 9, "bold"), fg="black").place(x=12, y=402)
#txt_lb5 = ttk.Entry(app, font=("Arial Greek", 12, "bold")).place(x=100, y=405, width=130, height=18)

#label6 = tk.Label(app, text="Ad_Client       :", bg="#6A6A6A", font=("Arial Greek", 9, "bold"), fg="black").place(x=12, y=445)
#txt_lb6 = tk.Entry(app, font=("Arial Greek", 12, "bold")).place(x=100, y=448, width=130, height=18)
